...
HD_PWD='C:/EEC488/Project 1/vanilla_fpro/vanilla_fpro.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mcs_top_vanilla.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mcs_top_vanilla.tcl -notrace
