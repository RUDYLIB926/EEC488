...
HD_PWD='C:/Users/FH309/Desktop/vanilla_fpro/vanilla_fpro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mcs_top_vanilla.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mcs_top_vanilla.tcl
